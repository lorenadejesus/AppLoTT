...
namespace AppLot.Vistas
{
    ...
    public partial class AdminInicioSesion : ContentPage
    {
        public AdminInicioSesion()
        {
            InitializeComponent();
            btnIniciarAdmin.Clicked += BtnIniciarAdmin_Clicked;
btnOlvi.Clicked += BtnOlvi_Clicked;
        ...
        private void BtnIniciarAdmin_Clicked(object sender, EventArgs e)
        {
            ...
            {
                String sUsuario = correoElectronico.Text;
                String sPassword = contrasena.Text;
                ...
                else if ((sUsuario == "LotoTres@gmail.com") && (sPassword == "12345678"))
                {
                    Navigation.PushAsync(new Vistas.Admin());
                    LimpiarFormulario();
                }
                else
                {
                    DisplayAlert("Datos incorrectos", "No existe", "OK");
                    LimpiarFormulario();
                }
            }
            else
